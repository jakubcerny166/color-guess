...
document.getElementById("cName").innerHTML="( "+r+" , "+g+" , "+b+" )";
...
function guess(){
    if(document.activeElement.id==index){
        document.getElementById("cName").innerHTML="CORRECT !!";
        document.getElementById("cName").style.color="darkgreen";
    }
    else{
        document.getElementById("cName").innerHTML="WRONG !!";
